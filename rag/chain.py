...
_SOURCE_LABELS: dict[str, str] = {
    ...
    "pluginhive_seeds":     "PluginHive Knowledge Base & Guides",
    "test_cases_eparcel":   "eParcel Test Cases & Acceptance Criteria",
    "test_cases_mypost":    "MyPost Business Test Cases & Acceptance Criteria",
    "codebase":             "Automation Codebase (Playwright / TypeScript)",
    "automation":           "Automation Codebase",
    "backend":              "Backend Source Code",
    "frontend":             "Frontend Source Code",
    "app":                  "AU Post App UI Knowledge",
}
