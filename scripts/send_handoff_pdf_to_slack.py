...
would send and exits, so the target can be confirmed first.
    ...
    python3 scripts/send_handoff_pdf_to_slack.py --pdf data/handoff_docs/AUPost_Release_Support_Guide.pdf

    # send after approval
    python3 scripts/send_handoff_pdf_to_slack.py --pdf data/handoff_docs/AUPost_Release_Support_Guide.pdf --yes
