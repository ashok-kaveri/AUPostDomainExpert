...
Usage:
    ...
    result = check_and_draft_bug(
        issue_description="AU Post Signature on Delivery toggle saves but rates still show standard pricing",
        feature_context="AU Post Extra Cover — Settings page",
        release="AUPostapp 2.3.115",
    )
    ...
    def to_trello_desc(self) -> str:
        ...
        return dedent(f"""\
            ...
            **Labels:** {labels_str}
            ...
            ---
            *Raised via AU Post QA Pipeline — Bug Tracker*
        """).strip()
...
FORMAT_BUG_PROMPT = dedent("""\
    You are a senior QA engineer writing a bug report for the Australia Post Shopify App.
    ...
    - labels ALWAYS includes "QA Reported" and "AUPOST-APP" plus the severity label (P1/P2/P3/P4)
    - example labels output: ["QA Reported", "AUPOST-APP", "P2"]
""")
...
def check_and_draft_bug(
    ...
    Args:
        ...
        feature_context:    Optional feature/page context (e.g. "AU Post Extra Cover Settings")
        release:            Release label (e.g. "AUPostapp 2.3.115")
    ...
    try:
        fmt_prompt = FORMAT_BUG_PROMPT.format(
            ...
            feature_context=feature_context or "Australia Post Shopify App",
