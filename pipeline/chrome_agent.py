...
AGENT_STEP_PROMPT = dedent("""\
    You are a QA engineer navigating the Australia Post Shopify App to explore a feature
    ...
    {{
      ...
      "elements_captured": [
        ...
        "<toggle: AU Post Extra Cover [checked=false]>",
...
def explore_with_agent(
    ...
    """
    Run the Chrome agent to explore the AU Post Shopify app for a feature.
    ...
    Args:
        card_name:          Feature name, e.g. "AU Post Extra Cover"
