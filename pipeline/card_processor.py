...
TEST_CASE_PROMPT = dedent("""\
    You are a senior QA engineer for the Australia Post Shopify App built by PluginHive.
    ...
    **Steps:**
    Given <the initial state or precondition, e.g. "I am logged in to the PH Australia Post app">
    ...
    - Use "PH AU Post app" to refer to the PluginHive Australia Post Shopify App
...
AC_WRITER_PROMPT = dedent("""\
    You are a senior QA engineer and product owner for the Australia Post Shopify App
...
def format_qa_comment(
    ...
    Example output:
        📋 QA Test Cases — Dry Ice (AUPostapp 2.3.115)
