...
Usage:
    ...
    report = explore_feature(
        app_url="https://your-shopify-store.myshopify.com/admin/apps/australia-post",
...
VISION_ANALYSER_PROMPT = dedent("""\
    You are a QA engineer testing the Australia Post Shopify App.
...
EXPLORATION_SUMMARY_PROMPT = dedent("""\
    You are a QA lead reviewing an exploration session for the Australia Post Shopify App.
