...
US_WRITER_PROMPT = """\
You are a senior Product Owner / Business Analyst for the PluginHive Australia Post Shopify app.
The app integrates Australia Post shipping (label generation, rate calculation, tracking, returns,
