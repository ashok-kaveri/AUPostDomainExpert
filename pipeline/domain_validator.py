...
Checks:
  ...
  3. Accuracy issues    — anything contradicting actual Australia Post app behaviour
  4. AU Post-specific     — API constraints, edge cases, app quirks
...
VALIDATION_PROMPT = dedent("""\
    You are a senior domain expert and QA lead for the Australia Post Shopify App built by PluginHive.
    ...
    {{
      ...
      "accuracy_issues": [
        "<anything in the description that contradicts how the Australia Post app actually works>"
      ],
      "suggestions": [
