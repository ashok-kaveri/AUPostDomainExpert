...
Supports:
  ...
  address_type: "default" (AU domestic) | "international"
"""
...
# For AC verification we don't need many orders — 5 is enough to prove bulk works.
_BULK_AC_COUNT = 5
...
_ADDRESS_TYPE_MAP = {
    ...
    # everything else → default (Australian domestic)
}
...
_EXISTING_UNFULFILLED_KEYWORDS = [
    "shipping address change without label",
]
...
def infer_order_decision(scenario: str) -> str:
    ...
    label_keywords = [
        ...
        "eparcel", "mypost", "parcel post", "express post",
