...
def test_ask_returns_answer_and_sources():
    ...
    mock_chain.invoke.return_value = {
        "answer": "Label generation creates an Australia Post shipping label via the REST API.",
        "source_documents": [
            Document(
            ...
            Document(
                page_content="Australia Post API label endpoint...",
                metadata={"source_url": "https://pluginhive.com/label-gen"},
            ),
        ],
    }
    ...
    assert result["answer"] == "Label generation creates an Australia Post shipping label via the REST API."
